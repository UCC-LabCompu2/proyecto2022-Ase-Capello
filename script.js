...
function calculateProjectileMotion() {
    ...
    } else if (document.getElementById("initial_height_units_from").value === "kilometer") {
        initialHeight = (document.getElementById("initial_height").value * 1000).toFixed(2);
    } else if (document.getElementById("initial_height_units_from").value === "feet") {
        initialHeight = (document.getElementById("initial_height").value * 0.3048).toFixed(2);
    } else if (document.getElementById("initial_height_units_from").value === "inches") {
        initialHeight = (document.getElementById("initial_height").value * 0.0254).toFixed(2);
    } else if (document.getElementById("initial_height_units_from").value === "yards") {
        initialHeight = (document.getElementById("initial_height").value * 0.9144).toFixed(2);
    }
    if (document.getElementById("gravity_units_from").value === "m/s²") {
